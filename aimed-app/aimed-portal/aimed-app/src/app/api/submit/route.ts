...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Convert structured sections back to plain text if report_text is missing
    if (!data.report_text && data.sections && typeof data.sections === "object") {
      const parts = [];
    ...
    if (data.report_text && (data.success === undefined || data.success === null)) {
      data.success = true;
    }
