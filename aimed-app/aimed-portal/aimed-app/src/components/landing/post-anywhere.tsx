...
export default function PostAnywhere() {
  return (
    <section
      id="integration"
      className="min-h-screen flex items-center py-20 px-6 bg-white border-y border-zinc-50 overflow-hidden relative"
    >
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-zinc-500 font-normal leading-relaxed max-w-lg">
              AIMED radi sa svim bolničkim sistemima. Kopirajte strukturirani
              tekst u Word, Outlook ili vaš EMR/HIS softver jednim klikom.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-8 p-8 rounded-3xl bg-zinc-50/50 border border-zinc-100 hover:bg-white hover:border-zinc-200 transition-all duration-500 group cursor-default"
              >
                ...
                <div className="space-y-1">
                  <h4 className="font-bold text-black text-xl tracking-tight">
                    {item.title}
                  </h4>
                  <p className="text-base text-zinc-500 font-normal leading-snug">
                    {item.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="relative z-10 bg-white rounded-[3.5rem] border border-zinc-100 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] p-12 max-w-lg mx-auto transition-transform duration-700 group-hover:-translate-y-2">
            ...
            <div className="space-y-8">
              <div className="h-48 w-full border border-dashed border-zinc-200 rounded-3xl bg-zinc-50/30 flex flex-col items-center justify-center p-10 gap-6 relative overflow-hidden">
                <div className="text-[11px] text-zinc-300 font-bold uppercase tracking-widest relative z-10">
                  Anamneza
                </div>
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div className="h-14 bg-zinc-900 rounded-2xl flex items-center justify-center text-white text-xs font-bold uppercase tracking-widest">
                  Spremi
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-10 -left-10 w-72 bg-zinc-900 border border-zinc-800 text-white p-8 rounded-3xl shadow-[0_30px_60px_-12px_rgba(0,0,0,0.5)] transform -rotate-2 transition-transform duration-500 group-hover:rotate-0">
              ...
              <div className="text-[13px] font-medium leading-relaxed text-zinc-400">
                &quot;...pacijent navodi bol u lijevoj strani grudnog
                koša...&quot;
              </div>
            </div>
          </div>
