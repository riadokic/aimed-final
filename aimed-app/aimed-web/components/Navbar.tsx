...
const Navbar: React.FC<{ onDemoClick: () => void }> = ({ onDemoClick }) => {
  ...
  const menuItems = [
    {
      label: "Proizvod",
      links: [
        { label: "Modovi Rada", href: "#features" },
        { label: "Integracije", href: "#integration" },
        { label: "Testimonijali", href: "#testimonials" }
      ]
    },
    {
      label: "Resursi",
      links: [
        ...
        { label: "GDPR Sigurnost", href: "#features" }
      ]
    }
  ];
