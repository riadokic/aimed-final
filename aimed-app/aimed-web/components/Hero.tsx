...
import { ArrowRight, PlayCircle, ShieldCheck, Mic, FileText } from 'lucide-react';
    ...
    <section className="relative pt-48 pb-32 px-6 overflow-hidden radial-glow">
      ...
      <div className="absolute inset-0 pointer-events-none hidden lg:block">
        ...
        <div className="absolute top-[35%] left-[5%] xl:left-[10%] animate-float-hero group pointer-events-auto">
          <div className="bg-white/40 backdrop-blur-md border border-zinc-100 p-4 rounded-3xl shadow-2xl shadow-zinc-200/30 flex flex-col gap-3 w-52 transform -rotate-3 transition-all duration-300 ease-in-out cursor-default group-hover:scale-105 group-hover:border-[2px] group-hover:border-zinc-300 group-hover:bg-white/70 group-hover:shadow-3xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                <span className="text-[9px] font-black text-zinc-400 uppercase tracking-widest">Audio In</span>
              </div>
              <Mic className="w-3 h-3 text-zinc-300" />
            </div>
            <div className="space-y-1.5 px-1">
              {/* Static visual for Audio In activity */}
        ...
        <div className="absolute top-[32%] right-[5%] xl:right-[10%] animate-float-hero-delayed group pointer-events-auto">
          <div className="bg-white/40 backdrop-blur-md border border-zinc-100 p-5 rounded-[2rem] shadow-2xl shadow-zinc-200/30 w-56 space-y-4 transform rotate-2 transition-all duration-300 ease-in-out cursor-default group-hover:scale-105 group-hover:border-[2px] group-hover:border-zinc-300 group-hover:bg-white/70 group-hover:shadow-3xl">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 bg-zinc-50 rounded-lg flex items-center justify-center">
                <FileText className="w-3.5 h-3.5 text-black/30" />
              </div>
              <div>
                <p className="text-[9px] font-black text-zinc-400 uppercase tracking-widest">AI Strukturiranje</p>
              </div>
            </div>
            {/* Dynamic 1px loading bar - 12s loop */}
      ...
      <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-200 bg-white shadow-sm animate-reveal">
          ...
          <span className="text-[12px] font-semibold text-zinc-600 tracking-tight uppercase tracking-widest">Inteligentna medicinska dokumentacija</span>
          ...
          <div className="flex flex-col sm:flex-row items-start justify-center gap-8">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-2 opacity-40 hover:opacity-100 transition-opacity duration-300 cursor-default group">
                ...
                <span className="text-[10px] font-bold text-zinc-900 uppercase tracking-[0.2em]">GDPR Compliant</span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-2 opacity-40 hover:opacity-100 transition-opacity duration-300 cursor-default group">
                <ShieldCheck className="w-4 h-4 text-zinc-900 group-hover:text-blue-500 transition-colors" />
                <span className="text-[10px] font-bold text-zinc-900 uppercase tracking-[0.2em]">ZZLP usklađeno</span>
              </div>
            </div>
          </div>
        </div>
