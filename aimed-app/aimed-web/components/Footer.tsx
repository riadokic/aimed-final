      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <ul className="space-y-4 text-sm text-zinc-400 font-medium">
              ...
              <li><a href="#pricing" className="hover:text-white transition-colors">Cijene</a></li>
              <li><a href="#features" className="hover:text-white transition-colors">GDPR Sigurnost</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 space-y-8">
            ...
            <div className="flex gap-4">
              <a href="https://linkedin.com/company/aimed" target="_blank" className="w-10 h-10 rounded-full border border-zinc-800 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://instagram.com/aimed" target="_blank" className="w-10 h-10 rounded-full border border-zinc-800 flex items-center justify-center hover:bg-white hover:text-black transition-all">
        ...
        <div className="pt-12 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8 text-[12px] font-medium text-zinc-500">
            ...
            <a href="#" className="hover:text-white transition-colors">GDPR Consent</a>
          </div>
        </div>
      </div>
    </footer>
